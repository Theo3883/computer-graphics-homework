...
% Smooth doar interpoleaza vizual; nu creste neaparat fidelitatea numerica.
% -----------------------------------------------------------------
\begin{frame}
  \begin{figure}
    \center
...
%   - \addplot adaugă un plot folosind doar opțiunile locale date la acel plot.
%   - \addplot+ adaugă un plot și "moștenește" opțiunile globale ale axei, permițând suprascrierea/adaosul la acestea.
%   - Practic, \addplot+ combină opțiunile globale cu cele locale, \addplot folosește doar localele.
% -----------------------------------------------------------------
\begin{frame}
\begin{figure}
  \center
